...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$BackendPath'; Write-Host 'Starting Backend Service...' -ForegroundColor Green; mvn spring-boot:run" -WindowStyle Normal

# Start Frontend in a new window
Write-Host "Launching Frontend (Vite)..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$FrontendPath'; Write-Host 'Starting Frontend Application...' -ForegroundColor Green; npm run dev" -WindowStyle Normal
